...
<Meta title='new account page' keywords='new account page, wipster brother' description='basic wipster brother page' />
            ...
            <main className="form-signin">
                ...
                <div className="mb-3">
                <label for="exampleFormControlInput2" className="form-label">Second Name</label>
                ...
                <div className="mb-3">
                <label for="exampleFormControlInput4" className="form-label">Password</label>
                ...
                <div className="mb-3">
                <label for="exampleFormControlInput5" className="form-label">Password re-enter to confirm</label>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" className="form-label">Descritpion (optional)</label>
