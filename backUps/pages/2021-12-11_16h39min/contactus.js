...
<BackToTopButton />
    ...
    <div className="container">
       ...
       <Image src='/images/contactus-chat.png' width="100%" height="100%" layout="responsive" objectFit="contain"></Image>
...
{/* the form */}
    ...
    <div class="mb-3">
        <label for="contactUsFirstName" class="form-label">First Name</label>
        <input type="text" class="form-control" id="contactUsFirstName" placeholder="John" name='firstName'/>
        <ValidationError 
        prefix="Name" 
        field="firstName"
        errors={state.errors}
    ...
    <div class="mb-3">
  <label for="contactUsSecondName" class="form-label">Last Name</label>
  <input type="text" class="form-control" id="contactUsSecondName" placeholder="Smith" name='lastName' />
  <ValidationError 
        prefix="LastName" 
        field="lastName"
        errors={state.errors}
    ...
    <div class="mb-3">
    <label htmlFor="ContactUsEmail" class="form-label">Email</label>
    <input type="email" class="form-control" id="ContactUsEmail" placeholder="abc@mail.com" name='email' />
    <ValidationError 
        prefix="Email" 
        field="email"
        errors={state.errors}
...
<label htmlFor="contactUsPhone" class="form-label">Phone</label>

<div className="row g-0">

      <div className="col-2">
<select class="form-select" id="areaCodes" name='areaCode'>
...
<input type="number" class="form-control" id="contactUsPhone" placeholder="please do NOT include 0, zero in here" name='actualPhoneNumber'/>
<ValidationError 
...
<div class="mb-3">
  <label for="contactUsNumberOfEmployees" class="form-label">Number of employees</label>
  <select class="form-select" aria-label="Default select example" id="contactUsNumberOfEmployees" name='numberOfEmployees'>
...
<ValidationError 
 ...
 <div class="mb-3">
  ...
  <textarea class="form-control" id="contactUsMessage" rows="4" name='message'></textarea>
  <ValidationError 
        prefix="Message" 
        field="message"
        errors={state.errors}
