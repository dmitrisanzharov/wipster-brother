...
<div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div className={`carousel-inner  mt-4`}>
    ...
    <div className={`carousel-item active mb-4 mb-md-3`} data-bs-interval="10000">
      <Image src="/images/dell.png" width={200} height={200}></Image>
    </div>


    <div className={`carousel-item mb-4 mb-md-3`} data-bs-interval="2000">
    <Image src="/images/intel.png" width={200} height={200}></Image>
    </div>


    <div className={`carousel-item mb-4 mb-md-3`}>
    <Image src="/images/ITV.png" width={200} height={200}></Image>
    </div>

    <div className={`carousel-item mb-4 mb-md-3`}>
    <Image src="/images/Visa.png" width={200} height={200}></Image>
    </div>
  ...
  <section className="p-5" style={{background: '#F5F6F8'}}>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#2B79F8" class="bi bi-quote" viewBox="0 0 16 16">
  <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 9 7.558V11a1 1 0 0 0 1 1h2Zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612c0-.351.021-.703.062-1.054.062-.372.166-.703.31-.992.145-.29.331-.517.559-.683.227-.186.516-.279.868-.279V3c-.579 0-1.085.124-1.52.372a3.322 3.322 0 0 0-1.085.992 4.92 4.92 0 0 0-.62 1.458A7.712 7.712 0 0 0 3 7.558V11a1 1 0 0 0 1 1h2Z"/>
    ...
    <div>
      <Image src='/images/Caitlin+Conklin.png' width={160} height={80}></Image>
      <div className='h5 fw-bold'>Caitlin Conkin</div>

      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#2B79F8" class="bi bi-dash-lg" viewBox="0 0 16 16">
...
{/* the waves 1 */}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className='' id='homePageWave1'viewBox="0 0 1440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,256L80,240C160,224,320,192,480,192C640,192,800,224,960,218.7C1120,213,1280,171,1360,149.3L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className='' viewBox="0 0 1440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,256L80,240C160,224,320,192,480,192C640,192,800,224,960,218.7C1120,213,1280,171,1360,149.3L1440,128L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-12 col-md-6">
        <Image src='/images/wipster-stress-free-reviewing.png' width="100%" height="100%" layout="responsive" objectFit="contain"></Image>
          {/* end of col2 */}
        </div>
        {/* end of row */}
      </div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#198754" class="bi bi-dash-lg" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/>
</svg>
...
<div className="h5 fw-normal mb-5">Everything you need to know about industry trends, integrations and updates from the Wipster team.</div>
      ...
      <div className="card hoverButton">
        ...
        <div className="card-body text-start">
          ...
          <h6 class="card-subtitle mb-3 text-muted">Nov 11, 2021 by Wipster Content Team</h6>
      ...
      <div className="col-12 col-md-6 col-lg-4" onClick={()=> alert('page under development')}>
        ...
        <div className="card hoverButton">
          ...
          <div className="card-body text-start">
            ...
            <h6 class="card-subtitle mb-3 text-muted">Wipster Content Team : Nov 10, 2021 11:17:35 PM</h6>
       ...
       {/* COL 3 */}
        ...
        <div className="card hoverButton">
          ...
          <div className="card-body text-start">
            ...
            <h6 class="card-subtitle mb-3 text-muted">Wipster Content Team : Nov 10, 2021 11:16:28 PM</h6>
